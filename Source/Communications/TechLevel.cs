...
namespace RealismOverhaul.Communications
{
    public class TechLevel
    {
        ...
        public TechLevel(float efficiency, float gain, float minDataRate, float maxPower, float massPerWatt, float baseMass, float basePower, float frequency, float baseCost, float costPerWatt)
        {
        ...
        {
            new TechLevel(1/18f, -13f, 4, 0.1f, 1.6f, 1, 20.5f, 8415f, 2, 5),
            new TechLevel(1/13f, -10f, 4, 1, 1.34f, 0.26f, 20.5f, 8415f, 4, 4),
            new TechLevel(1/10f, -4.5f, 1, 5, 1.16f, 6.9f, 20.5f, 8415f, 30, 3.5f),
            new TechLevel(3/23f, -2.5f, 8, 5, 1, 20.2f, 20.5f, 8415f, 50, 3),
